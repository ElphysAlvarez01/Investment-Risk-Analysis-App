...
st.set_page_config(page_title="Risk Management App", layout="wide")
...
sidebar_css = """
    <style>
        /* Sidebar background color - NAVY BLUE */
        [data-testid="stSidebar"] {
            background-color: #38B6FF !important;  /* Dark Navy Blue */
        }
        ...
        /* Ensure active tab has a lighter blue */
        [data-testid="stSidebarNav"] .st-emotion-cache-10trblm {
            background-color: #38B6FF !important;  /* Lighter Navy Blue */
            border-radius: 10px;
            padding: 10px;
            color: white !important; /* Ensures selected tab text is white */
        }
    </style>
"""
...
# ✅ Main Page (Risk Analysis & Simulations)
st.subheader("Use the Risk Parameters below to create & Analyze different scenarios.")
st.write("Go to the User Guide tab for additional details.")
...
# ✅ Trade Logger Page
with tab3:
    Trading_Journal.main()


# ✅ Risk Analysis Page (Just Placeholder for now)
with tab4:
    Risk_Analysis_dashboard.main()
